"""trigger recalcular valor_pago em contas_financeiras
...
# Trigger SQL — só executado no PostgreSQL
_CREATE_FUNCTION = """
...
BEGIN
    ...
    SET
        valor_pago = COALESCE((
            ...
            WHERE pf.conta_financeira_id = cf.id
        ...
        status = CASE
            ...
            ELSE 'pendente'
        END
    WHERE cf.id = COALESCE(NEW.conta_financeira_id, OLD.conta_financeira_id);
    RETURN NULL;
END;
$$;
"""
