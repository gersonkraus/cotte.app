...
class ComercialCampanhas {
    ...
    async loadCampanhas() {
        try {
            const response = await fetch('/tenant/comercial/campaigns');
    ...
    async loadTemplates() {
        try {
            const response = await fetch('/tenant/comercial/templates');
    ...
    async loadLeads(reset = true) {
        ...
        try {
            ...
            const response = await fetch(`/tenant/comercial/leads${query}`);
    ...
    async startDisparo(campanhaId) {
        ...
        try {
            const response = await fetch(`/tenant/comercial/campaigns/${campanhaId}/disparo`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async viewMetrics(campanhaId) {
        try {
            const response = await fetch(`/tenant/comercial/campaigns/${campanhaId}/metrics`);
    ...
    async deleteCampanha(campanhaId) {
        ...
        try {
            const response = await fetch(`/tenant/comercial/campaigns/${campanhaId}`, {
                method: 'DELETE'
            });
