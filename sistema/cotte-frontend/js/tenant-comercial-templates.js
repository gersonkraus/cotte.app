...
class ComercialTemplates {
    ...
    async saveTemplate() {
        ...
        try {
            let response;
            if (id) {
                response = await fetch(`/tenant/comercial/templates/${id}`, {
                    method: 'PUT',
                    headers: {
                ...
                response = await fetch('/tenant/comercial/templates', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    async deleteTemplate(id) {
        ...
        try {
            const response = await fetch(`/tenant/comercial/templates/${id}`, {
                method: 'DELETE'
            });
    ...
    async previewTemplate(templateId) {
        ...
        try {
            const response = await fetch(`/tenant/comercial/templates/${templateId}/preview?lead_id=${leadId}`);
