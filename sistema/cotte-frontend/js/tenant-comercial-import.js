...
class ComercialImport {
    ...
    async loadSegments() {
        try {
            const raw = await api.get('/tenant/comercial/import/segments');
    ...
    async previewImport() {
        ...
        try {
            this.previewData = await api.post('/tenant/comercial/import/preview', {
                metodo: method,
                dados: data
            });
            this.renderPreview();
    ...
    async executeImport() {
        ...
        try {
            ...
            const result = await api.post('/tenant/comercial/import/execute', {
                metodo: method,
                dados: data,
