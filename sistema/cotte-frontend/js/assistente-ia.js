...
function getOrcamentoFollowupSuggestions(data, parsedSuggestions) {
...
function processAIResponse(data, loadingMessage, isStreamed = false) {
    ...
    if (isSuccess) {
        ...
        const tipoSemFeedback = ['onboarding', 'orcamento_preview', 'orcamento_criado', 'operador_resultado'];
