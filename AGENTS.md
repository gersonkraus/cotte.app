...
- Explicar de forma clara e direta.

## Regras gerais
- Sempre entender o pedido antes de editar.
- Sempre investigar os arquivos relevantes antes de propor mudanças.
- Sempre fazer a menor alteração possível.
- Não refatorar grandes áreas do projeto sem pedido explícito.
...
- Não inventar dependências, serviços, rotas ou arquivos.
- Não assumir comportamento sem evidência no código.

## Prioridades
1. Corrigir bugs reais.
2. Preservar funcionamento atual.
3. Evitar regressão em frontend.
4. Evitar quebra de integração frontend/backend.
...
- Antes de alterar JS, verificar eventos, seletores, chamadas de API e comportamento do DOM.
